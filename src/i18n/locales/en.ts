export const en = {
  ...
  jameelHome: {
    ...
    hero: {
      title: 'Your Jameel\nMotors hub',
      body: 'Services, brands, and\nelectric mobility in\none place.',
      cta: 'Start a quiz',
      imageAlt: 'Night city highway and mobility infrastructure',
    },
    quickActions: {
      testDrive: {
    ...
    membership: {
      ...
      body: 'A light preview for future initiatives, benefits, and event-led moments in the app.',
